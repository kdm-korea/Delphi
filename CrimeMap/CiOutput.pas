...
procedure TForm5.DevelopmentInfo1Click(Sender: TObject);
begin
  Unit3.Form3.Show;
end;

procedure TForm5.MapSetting1Click(Sender: TObject);
begin
  CiMapSet.FMapSet.Show;
end;

procedure TForm5.ProgramInfo1Click(Sender: TObject);
begin
  FProgramInfo.Show;
end;
